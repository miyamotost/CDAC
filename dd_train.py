...
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_utt1 = dd_data_helpers.fit_transform(x_text[1], vocab_processor, vocab)
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_utt2 = dd_data_helpers.fit_transform(x_text[2], vocab_processor, vocab)
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_utt3 = dd_data_helpers.fit_transform(x_text[3], vocab_processor, vocab)
...
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_pos0_shuf = dd_data_helpers.fit_transform_pos(x_pos0_shuf, vocab_processor)
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_pos1_shuf = dd_data_helpers.fit_transform_pos(x_pos1_shuf, vocab_processor)
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_pos2_shuf = dd_data_helpers.fit_transform_pos(x_pos2_shuf, vocab_processor)
vocab_processor = np.zeros([len(x_text[0]), max_document_length])
x_pos3_shuf = dd_data_helpers.fit_transform_pos(x_pos3_shuf, vocab_processor)
